...
var _testTabSchema = {
	...
	"type": "object",
	"properties": {
		"user": (0, _jsonDeepCopy2.default)(_testAgeSchema),
		"location": (0, _jsonDeepCopy2.default)(_testCoordinateSchema)
	}
};
...
var _testTabSchema2 = {
	...
	"properties": {
		...
		"pets": {
			...
			"type": "object",
			"properties": {
				"cat": (0, _jsonDeepCopy2.default)(_testAgeSchema),
				"dog": (0, _jsonDeepCopy2.default)(_testAgeSchema)
			}
		},
		"phone": {
			"title": "phone numbers",
