...
(function () {
  d3.timeline = function() {
    ...
    var appendTimeAxisCalendarYear = function (nav) {
      var b = typeof beginning === 'number' ? new Date(beginning) : beginning;
	  var e = typeof ending    === 'number' ? new Date(ending)    : ending;
      var calendarLabel = b.getFullYear();

      if (b.getFullYear() != e.getFullYear()) {
        calendarLabel = b.getFullYear() + "-" + e.getFullYear()
      }
