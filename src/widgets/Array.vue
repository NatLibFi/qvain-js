	...
	<b-card-body>
		...
		<b-list-group flush>
			...
			<!-- style="border-left: 2px solid #aaaaaa; padding-left: 1em; margin-left: 1em;" -->
				<TabSelector :schema="schemaForChild(index)" :path="newPath(index)" :value="value[index]" :parent="parent[property]" :property="index" :tab="myTab" :activeTab="activeTab" :depth="depth" 
			@delete="deleteElement" :key="'array-' + index"></TabSelector>
			</b-list-group-item>
