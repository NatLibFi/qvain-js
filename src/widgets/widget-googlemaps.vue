<template>
	<div>
		...
		<b-container fluid>
			<b-row class="my-1">
				<b-col sm="2"><label for="input-address">{{ ui['label'] || "coordinates" }}</label></b-col>
				<b-col sm="10">
					<b-input-group :state="addressState" :description="ui['description']" :label="ui['label']">
...
export default {
	...
	description: "map widget based on Google Maps",
	schematype: 'object',
	data: function() {
		return {
			address: "",
