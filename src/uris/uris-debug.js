...
(URI = function( value ) {
  ...
  heirpart: function() {
  	...
  	console.log(heirpart, typeof heirpart, heirpart.length);
...
(URI.HeirPart = function( value ) {
	this.value = value;
	console.log("constructor", typeof this.length, typeof this);
	this.length = value.length;
	var tmp = this.length;
	console.log("constructor", this.length, tmp, value.length);
	String.call( this , value );
}).prototype = {
  __proto__: String.prototype,
  toString: function() { return this.value.toString(); },
   ...
   */
  path: function() {
	console.log("!", this.length, this.authority().length);
